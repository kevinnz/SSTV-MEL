...
public struct SSTVDecoder {
    ...
    private func findSignalStartFM(
        ...
        // Wider tolerance for FM demod noise: ~12.5% of 1200 Hz, chosen empirically
        // from FM-demod test captures to absorb drift/quantization while still
        // reliably isolating sync pulses (see ADR-001 for tuning guidance).
